...
res.em <- rbind(
  res.em, 
  cbind(summary(em.pn)$coef[2:3, ], confint(em.pn)[2:3, ])
)
...
summary(em.stroke)$coef[2:3, ]
confint(em.stroke)[2:3, ]
res.em <- rbind(
  res.em, 
  cbind(summary(em.stroke)$coef[2:3, ], confint(em.stroke)[2:3, ])
)
...
summary(em.parkin)$coef[2:3, ]
confint(em.parkin)[2:3, ]
res.em <- rbind(
  res.em, 
  cbind(summary(em.parkin)$coef[2:3, ], confint(em.parkin)[2:3, ])
)
...
summary(em.abc)$coef[2:3, ]
confint(em.abc)[2:3, ]


#------------------------------------Data visualization------------------------------------
res.em <- as.data.frame(rbind(
  cbind(summary(em.age)$coef[2:3, ], confint(em.age)[2:3, ]),
  cbind(summary(em.parkin)$coef[2:3, ], confint(em.parkin)[2:3, ]),
  cbind(summary(em.pn)$coef[2:3, ], confint(em.pn)[2:3, ]),
  cbind(summary(em.stroke)$coef[2:3, ], confint(em.stroke)[2:3, ]), 
  cbind(summary(em.abc)$coef[2:3, ], confint(em.abc)[2:3, ])
))
colnames(res.em)
rownames(res.em) <- gsub("TreatmentCode0", ":Treatment", rownames(res.em))
rownames(res.em) <- gsub("0", "(No)", rownames(res.em))
rownames(res.em) <- gsub("1", "(Yes)", rownames(res.em))
rownames(res.em)
...
res.table <- data.frame(
  ...
  `Coefficient(95%CI)` = paste0(res.em$Estimate, " (", res.em$`2.5 %`, " to ", res.em$`97.5 %`,")"),
  `P-value`            = res.em$`Pr(>|t|)`
)
cex <-  0.75
